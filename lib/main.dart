  ...
  if (kIsWeb) {
    await Firebase.initializeApp(
      options: const FirebaseOptions(
        apiKey: "AIzaSyChxzbKB0f_bsRuXZL1P2dRI-TVbLLEM6E",
        appId: "1:1032461596954:web:3422bbc082ff763ce9d4a3",
        messagingSenderId: "1032461596954",
        projectId: "instagram-clone-334b6",
        storageBucket: "instagram-clone-334b6.appspot.com",
      ),
    );
  } else {
    await Firebase.initializeApp();
